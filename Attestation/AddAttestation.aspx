...
<%@ Page language="c#" Codebehind="AddAttestation.aspx.cs" AutoEventWireup="false" Inherits="kadry.Attestation.AddAttestation" codePage="65001"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Информационная система обработки данных "Кадры" - Добавление аттестации...</title>
				...
				<TBODY>
					...
					<TR vAlign="top">
						<TD style="HEIGHT: 15px" vAlign="top" align="center" height="15">
							<P class="Header" align="center">ДОБАВЛЕНИЕ&nbsp;АТТЕСТАЦИИ...</P>
						</TD>
					</TR>
					<TR vAlign="top">
							...
							<TABLE class="maintext" id="Table1" style="WIDTH: 742px; HEIGHT: 390px" tabIndex="0" cellSpacing="1"
								...
								<TR>
									<TD class="maintext" style="WIDTH: 276px; HEIGHT: 371px" vAlign="top" align="center"
										...
										<asp:label id="fio" runat="server" Font-Names="Verdana" Font-Bold="True" Font-Italic="True"
								...
								<TR>
									<TD class="maintext" style="WIDTH: 276px" vAlign="top" align="center" width="276" colSpan="2"
										...
										&nbsp;
										<asp:imagebutton id="Button_add" runat="server" ImageUrl="..//images//btn_add.gif"></asp:imagebutton></TD>
								</TR>
							</TABLE>
						</TD>
					</TR>
