...
namespace UK
{
	...
	public class search : System.Web.UI.Page
	{
		...
		protected UK.nationDataSet nationDataSet;
		...
		protected UK.zvanDataSet zvanDataSet;
		...
		protected UK.sluzDataSet phDataSet;
 ...
 //       protected global::System.Web.UI.WebControls.SqlDataSource uvDataSource;
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (!IsPostBack)
			{
				...
				Command.CommandText = "SELECT * FROM PODRAZD.DBF WHERE KEY_OF_POD IN (SELECT DISTINCT PODRAZD FROM " + UK.Vars.sbase + ")";
//				(KEY_OF_POD>=1 AND KEY_OF_POD<=31)OR(KEY_OF_POD IN (54,152,312))
				...
				Command.CommandText = "SELECT * FROM NACIONAL.DBF WHERE KEY_OF_NAC IN (SELECT DISTINCT NACIONALN FROM " + UK.Vars.sbase + ") ORDER BY NACION";
				DataAdapter.SelectCommand = Command;
				...
				Command.CommandText = "SELECT * FROM SLUZBA.DBF WHERE KEY_OF_SLU IN (SELECT DISTINCT SLUZBA FROM " + UK.Vars.sbase + ") ORDER BY NAM_OF_SLU";
				DataAdapter.SelectCommand = Command;
				...
				Command.CommandText = "SELECT * FROM ZVANIE.DBF WHERE KEY_ZVAN IN (SELECT DISTINCT ZVANIE FROM " + UK.Vars.sbase + ") ORDER BY VOIN_ZVAN";
				DataAdapter.SelectCommand = Command;
                ...
                //istDataSource.SelectCommand = "SELECT * FROM SLVISOD.DBF WHERE CODE IN (SELECT IST_SOD FROM " + UK.Vars.sbase + ")";
		...
		{    
			...
			this.nationDataSet = new UK.nationDataSet();
			this.mainDataSet = new UK.mainDataSet();
			this.sluzDataSet = new UK.sluzDataSet();
			this.zvanDataSet = new UK.zvanDataSet();
			...
			this.phDataSet = new UK.sluzDataSet();
			...
			// LogsConn
			// 
            this.LogsConn.ConnectionString = "Data Source=COMP2;Initial Catalog=IAS;Persist Security Info=True;User ID=sa;Password=*";
			// 
			// AddLogsCmd
			// 
		 ...
		 protected void GoBtn_Click1(object sender, ImageClickEventArgs e)
        {
			...
			if ( dolzList.SelectedValue != "0" )
			{
				...
				{
                    Command.CommandText += " AND DOLZNOST > '800000' AND POTOLOK NOT IN (80,81)";
				}
                if (dolzList.SelectedValue == "5")
                {
                    Command.CommandText += " AND DOLZNOST > '800000' AND POTOLOK IN (80,81)";
                }
			}
            ...
            //// ���� ������������ ����������
            //if ((UK.Vars.sbase == "AAQQ.DBF" || UK.Vars.sbase == "RESERV.DBF") && (Att_Date.Text != ""))
            //{
            //    string att_keys = "";
            ...
            //// ������������ ���������� (���������)
            //if ((UK.Vars.sbase == "AAQQ.DBF" || UK.Vars.sbase == "RESERV.DBF") && AttCheckBox.Checked)
            //{
            //    string att_keys = "";
            ...
            //// ������������ ���������� (�����������)
            //if ((UK.Vars.sbase == "AAQQ.DBF" || UK.Vars.sbase == "RESERV.DBF") && NoAttCheckBox.Checked)
            //{
            //    string att_keys = "";
            //    uvDataSource.SelectCommand = "SELECT id FROM PoliceAttestation WHERE att_date is not null";
            //    //uvDataSource.SelectParameters.Add("key", mainDataSet._Table.Rows[i]["KEY_1"].ToString());
            ...
            // ����������...
            if ((UK.Vars.sbase == "AAQQ.DBF" || UK.Vars.sbase == "RESERV.DBF") && CheckDecret.Checked)
            {
            ...
            // ����������...
            if ((UK.Vars.sbase == "AAQQ.DBF" || UK.Vars.sbase == "RESERV.DBF") && prizCheckBox.Checked)
            {
...
//					if (Check1.Checked)
//					{
//						UK.Vars.CmdText = Command.CommandText;
//						string Params = "";
//
...
//					{
						...
						for (int i = 0; i <= mainDataSet._Table.Rows.Count - 1; i++ )
						{
                            ...
                            //if (UK.Vars.sbase == "AAQQ.DBF" || UK.Vars.sbase == "RESERV.DBF")
                            //{
                            //    // ��������� ������� �����.����������...
...
//					if (Check2.Checked && !Check3.Checked) Grid.Columns[10].Visible = false;
                    ...
                    //if ( (UK.Vars.Keys.Split(Convert.ToChar(","))).Length > 1)
                    //{
			...
			{
				UK.Vars.Keys = UK.Vars.Keys.Substring(0,UK.Vars.Keys.Length-1);
		...
		{
			string[] keys = UK.Vars.Keys.Split(Convert.ToChar(","));
...
//				}
        ...
        {
            UK.WordExcel.ExportGridToExcel(this, Grid, "������");
        }

        protected void WordCopyButton_Click(object sender, ImageClickEventArgs e)
        {
            UK.WordExcel.ExportGridToWord(this, Grid, "������");
        }
